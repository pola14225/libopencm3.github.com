...
<tagfile>
  ...
  <compound kind="group">
    <name>tim5_opt_trigger_remap</name>
    <title>TIM5_OR Timer 5 Option Register Internal Trigger 4 Remap</title>
    <filename>group__tim5__opt__trigger__remap.html</filename>
  </compound>
  <compound kind="group">
